 ...
 *   https://datatables.net/download/#dt/dt-1.10.18/b-1.5.6/fc-3.2.5/fh-3.1.4
 *
 * Included libraries:
 *   DataTables 1.10.18, Buttons 1.5.6, FixedColumns 3.2.5, FixedHeader 3.1.4
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"dt/dt-1.10.18/b-1.5.6/fc-3.2.5/fh-3.1.4",
			...
			jqueryui: function ( settings, cell, column, classes ) {
				...
				$(settings.nTable).on( 'order.dt.DT', function ( e, ctx, sorting, columns ) {
					...
					cell
						...
						.addClass( columns[ colIdx ] == 'asc' ?
							classes.sSortJUIDesc : columns[ colIdx ] == 'desc' ?
								classes.sSortJUIAsc :
